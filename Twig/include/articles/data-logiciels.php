...
// Articles logiciels en FR et DK
$dataLogiciels = [
    'fr' => [
        [
            "titre" => "FL Studio",
    ...
    'dk' => [
        [
            "titre" => "FL Studio",
            "q" => "The fastest way from your brain to your speakers",
            "presentation" => "FL Studio er et musikproduktionsprogram, der også er kendt som Fruity Loops. Det er udviklet af det belgiske firma Image-Line Software. Det giver dig mulighed for at skabe, producere og mixe elektronisk musik på en pc. Det tilbyder en række værktøjer til optagelse, redigering, manipulering og manipulering af lydspor samt funktioner til virtuel synthesizer, trommemaskine og effekter til at skabe komplette musiknumre. Det er meget populært blandt DJ'er, musikproducere og amatørmusikere på grund af dets brugervenlighed og mange forskellige funktioner.",
            "img" => "FLSTUDIO",
            "lien" => "https://www.image-line.com/",
            "features" => [
                ["Sporrediger", "Tillader at oprette, redigere og synkronisere lyd- og MIDI-spor."],
                ["Virtuelle synthesizere", "Tilbyder en række forskellige synthesizere, inklusiv FM-synthesizere, bølgeformsynthesizere, fysiske modellering syntherisizere og mere."],
                ["Trommebokse", "Tilbyder en række forskellige trommebokse, inklusiv trommebokse, basbokse, perkussionsbokse og mere."],
                ["Effekter", "Tilbyder en række forskellige lydeffekter, såsom reverb, delays, filtre, distorsioner, equalizere og mere."],
                ["Lydoptagelse", "Tillader optagelse af lydspor direkte fra et mikrofon eller lydinterface."],
                ["Mixing og mastering", "Tilbyder værktøjer til at mixe spor og til mastering for at gøre dem mere professionelle."],
                ["Automatisering", "Tillader at oprette automatiseringens kurver for plugin- og sporgeparametre."],
                ["Understøttelse af flere formater", "Understøtter lydformater som WAV, MP3, OGG, MIDI og mere."],
                ["Understøttelse af flere platforme", "Er tilgængeligt for Windows og Mac."],
                ["Brugergrænseflade kan tilpasses", "Tillader at tilpasse brugergrænsefladen til dine produktionsbehov."]
            ]
        ],
        [
            "titre" => "Ableton Live",
            "q" => "Add more feeling to your music",
            "presentation" => "Ableton Live er et musikproduktionsprogram, der giver brugeren mulighed for at skabe, optage, producere og mixe elektronisk musik. Det tilbyder realtidskompositionsfunktioner, håndtering af lydklips og MIDI-kontrol. Det findes i to versioner: Ableton Live Standard og Ableton Live Suite. Suite-versionen inkluderer virtuelle instrumenter og ekstra effekter. Ableton Live bruges af mange musikere, producere og DJ'er til at skabe musik i studiet og til liveoptagelser.",
            "img" => "ABLETON",
            "lien" => "https://www.ableton.com/en/live/",
            "features" => [
                ["Realtidskomposition", "Ableton Live giver mulighed for at skabe numre ved hjælp af lyd- og MIDI-klips, der kan startes, synkroniseres og loopes i realtid."],
                ["Optagelse af lyd og MIDI", "Ableton Live giver mulighed for at optage lyd- og MIDI-spor fra eksterne kilder, som elektroniske instrumenter eller mikrofoner."],
                ["Redigering af lyd og MIDI", "Ableton Live har redigeringsværktøjer til at skære, flytte og ombearbejde lyd- og MIDI-klips."],
                ["Lyd- og MIDI-effekter", "Ableton Live inkluderer en række lyd- og MIDI-effekter til at tilføje dybde og tekstur til dine numre."],
                ["Virtuelle instrumenter", "Ableton Live Suite-versionen inkluderer virtuelle instrumenter, såsom synthesizere, trommemaskiner og virtuelle akustiske instrumenter."],
                ["Mixning", "Ableton Live giver mulighed for at mixe de forskellige lyd- og MIDI-spor for at skabe en balanceret lyd i dit nummer."],
                ["Livepræsentation", "Ableton Live er designet til livepræsentationer, med funktioner som start af klip i realtid og muligheden for at styre parametre live ved hjælp af en ekstern MIDI-controller."]
            ]
        ],
        [
            "titre" => "Bitwig Studio",
            "q" => "Modern music production and performance for Windows, macOS, and Linux.",
            "presentation" => "Bitwig Studio er et musikproduktionsprogram til Windows, macOS og Linux. Det giver brugeren mulighed for at oprette, optage, producere og mixe elektronisk musik. Det har realtids komposition, audio-clip manipulation og MIDI-kontrol, lignende Ableton Live. Det indeholder virtuelle instrumenter, lydeffekter, mix- og redigeringsværktøjer samt understøttelse af eksterne MIDI-controllere. Bitwig Studio sammenlignes ofte med Ableton Live på grund af lignende funktioner, men det tilføjer unikke funktioner som lydbølgemodellering, formbølgeformmodellering og et moduleringsmodulært system. Det bruges af mange producere, musikere og DJ'er til at skabe musik i studiet og til live-optrædener.",
            "img" => "BITWIG",
            "lien" => "https://www.bitwig.com/",
            "features" => [
                ["Sporredigering", "Tillader oprettelse, redigering og synkronisering af audio- og MIDI-spor i realtid."],
                ["Audio- og MIDI-optagelse", "Tillader optagelse af audio- og MIDI-spor fra eksterne kilder, såsom elektroniske instrumenter eller mikrofoner."],
                ["Audio- og MIDI-redigering", "Har redigeringsværktøjer til at skære, flytte og bearbejde audio- og MIDI-clips."],
                ["Audio- og MIDI-effekter", "Indeholder en række audio- og MIDI-effekter til at tilføje dybde og tekstur til dine numre."],
                ["Virtuelle instrumenter", "Indeholder virtuelle instrumenter, såsom synther, trommemaskiner og virtuelle akustiske instrumenter."],
                ["Mix", "Giver mulighed for at mixe de forskellige audio- og MIDI-spor for at skabe en balanceret lyd i dit nummer."],
                ["Live-præstation", "Designet til live-præstationer med funktioner som realtidsudløsning af clips og mulighed for at styre parametre live ved hjælp af en ekstern MIDI-controller."],
                ["Moduleringsmodulært system", "Indeholder et moduleringsmodulært system til at skabe moduleringsrelationer mellem forskellige parametre."],
                ["Lydbølgemodellering", "Indeholder værktøjer til lydbølgemodellering til synthesizer-effekter."],
                ["Formbølgeformmodellering", "Muliggør deformation og transformation af audioformbølger for at skabe unikke lyde."]
            ]
        ],
        [
            "titre" => "Logic Pro",
            "q" => "Forfærdelig kraftfuld. Vidunderligt kreativt.",
            "presentation" => "Logic Pro er et musikproduktionsprogram til Mac. Det giver brugeren mulighed for at skabe, optage, producere og mixe elektronisk musik. Det har realtidskompositionsegenskaber, audio-klipbehandling og MIDI-kontrol. Det inkluderer virtuelle instrumenter, lydeffekter, mixer- og redigeringsværktøjer samt understøttelse af eksterne MIDI-controller. Logic Pro bruges af mange producere, musikere og DJ'er til at skabe studiemusik og til liveoptrædener.",
            "img" => "LOGIC_PRO",
            "lien" => "https://www.apple.com/dk/logic-pro/",
            "features" => [
                ["Realtidskomposition", "Tillader oprettelse af numre ved hjælp af audio- og MIDI-klip, der kan startes, synkroniseres og loops i realtid."],
                ["Audio- og MIDI-optagelse", "Tillader optagelse af audio- og MIDI-spor fra eksterne kilder, såsom elektroniske instrumenter eller mikrofoner."],
                ["Audio- og MIDI-redigering", "Har redigeringsværktøjer til at skære, trimme, flytte og omskrive audio- og MIDI-klip."],
                ["Lyd- og MIDI-effekter", "Inkluderer en række lyd- og MIDI-effekter for at tilføje dybde og tekstur til dine numre."],
                ["Virtuelle instrumenter", "Inkluderer virtuelle instrumenter, såsom synthesizere, trommemaskiner og virtuelle akustiske instrumenter."],
                ["Mixning", "Tillader mixning af forskellige audio- og MIDI-spor for at skabe en balanceret lyd i dit nummer."],
                ["Liveperformance", "Designet til liveperformance, med funktioner som realtids-klipstart og mulighed for at styre parametre live ved hjælp af en ekstern MIDI-controller."],
                ["Avancerede kompositionsfunktioner", "Inkluderer avancerede funktioner til komposition, såsom værktøjer til oprettelse af rytmer, værktøjer til oprettelse af loops og værktøjer til oprettelse af mønstre."],
                ["Professionelle mixeringsværktøjer", "Inkluderer professionelle mixeringsværktøjer til at skabe balancerede lydbilleder og tilføje professionelle effekter til dine numre."],
                ["Plug-in-understøttelse", "Understøtter VST og AU plug-ins for at tilføje endnu flere funktioner til din musikproduktionsworkflow."]
            ]
        ],
        [
            "titre" => "Pro Tools",
            "q" => "Legendary music starts here.",
            "presentation" => "Pro Tools er et lydproduktionssoftware til Mac og Windows. Det giver brugerne mulighed for at skabe, optage, producere og mixe elektronisk musik, film, tv-shows, podcasts og meget mere. Det tilbyder lyd- og MIDI-optagelse, lydredigering, lydeffekter, mixing og kompositionsværktøjer. Den understøtter VST- og AU-plugins for at tilføje endnu flere funktioner til din lydproduktionsworkflow. Pro Tools bruges af mange optagestudier, producere, musikere, komponister og ingeniører til at skabe lydprojekter af høj kvalitet.",
            "img" => "PRO_TOOLS",
            "lien" => "https://www.avid.com/pro-tools",
            "features" => [
                ["Lyd- og MIDI-optagelse", "Pro Tools giver dig mulighed for at optage lyd- og MIDI-spor fra eksterne kilder, f.eks. elektroniske instrumenter eller mikrofoner."],
                ["Lydredigering", "Pro Tools har redigeringsværktøjer til at klippe, dekonstruere afbalancerede lydsignaler og tilføje professionelle effekter til dine tracks."],
                ["Plug-in-understøttelse", "Logic Pro understøtter VST- og AU-plugins for at tilføje endnu flere funktioner til din musikproduktionsworkflow."],
            ]
        ]
    ]
];