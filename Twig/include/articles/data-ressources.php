...
// Articles ressources en FR et DK
$dataRessources = [
    'fr' => [
        [
    ...
    'dk' => [
        [
            ...
            "listePuce" => [
                ["'POWERFUL COLOR BASS DROP [HOW TO]' lavet af CRWTH", "https://youtube.com/watch?v=6WBXD65WUTQ"],
                ["'HOW TO MAKE COLOUR BASS!' lavet af Infowler", "https://youtube.com/watch?v=tqD5aNj-g6A"],
                ["'HOW TO COLOR BASS' lavet af Looma", "https://youtube.com/watch?v=kHe-s6liVYc"],
                ["'How To Make COLOR BASS' lavet af CyberBlitz", "https://youtube.com/watch?v=8wMs5f6RxaI"]
            ]
        ],
        [
            "titre" => "Ableton Vejledninger",
            "listePuce" => [
                ["'HOW TO CREATE COLOUR BASS IN UNDER A MINUTE' lavet af YokuMusic", "https://youtube.com/watch?v=U2DeYsM4cFs"],
                ["'How to Color Bass' lavet af Ash", "https://youtube.com/watch?v=AkStN2lgA7M"],
                ["'The secret to watery colour bass' lavet af Ash", "https://youtube.com/watch?v=uGNtWeDrmnc"],
                ["'HOW TO MAKE COLOR BASS IN ABLETON LIVE' lavet af OvaSenpai", "https://youtube.com/watch?v=F4AMGdNceJg"]
            ]
        ],
        [
            "titre" => "Musikteori",
        ...
        [
            "titre" => "Nyttige Ressourcer",
            "listePuce" => [
                ["Splice.com | Samples og nyttige værktøjer til musikproduktion", "https://splice.com/"],
                ["Vital.audio | Et komplet og gratis synthesizer-plugin", "https://vital.audio/"],
                ["XFer | Gratis / betalelige plugins nyttige til musikproduktion", "https://xferrecords.com/"]
            ]
        ],
        [
            "titre" => "Amazon-synthesizere",
            "listePuce" => [
                ["AKAI Professional APC Key 25 MK2", "https://a.co/d/i9ng0KJ"],
                ["AKAI Professional MPK Mini MK3", "https://a.co/d/b6A6j9G"],
                ["AKAI Professional LPK25", "https://a.co/d/0pO7egA"],
